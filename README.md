...
[![codecov](https://codecov.io/gh/countstarss/fastapi-template/branch/main/graph/badge.svg?token=fastapi-template_token_here)](https://codecov.io/gh/countstarss/fastapi-template)
[![CI](https://github.com/countstarss/fastapi-template/actions/workflows/main.yml/badge.svg)](https://github.com/countstarss/fastapi-template/actions/workflows/main.yml)

Awesome fastapi_template created by countstarss

## Install

from source
```bash
git clone https://github.com/countstarss/fastapi-template fastapi_template
cd fastapi_template
make install
```
